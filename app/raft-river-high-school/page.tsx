...
export default function Page() {
	return (
		<Card>
			<CardHeader>
				<h1 className="text-center">Raft River High School</h1>
			</CardHeader>
			...
			<CardContent>
				...
				<ul>
					...
					<li>
						Malta Ward Chapel: A gathering place for spiritual and civic life
						for over a century
					</li>
					<li>
					...
					<li>
						Agricultural milestones: The transformation of desert into
						productive farmland
					</li>
				</ul>
